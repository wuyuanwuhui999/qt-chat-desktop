...
本项目是一个基于c++使用qt搭建的ai智能体左面盈盈，它集成了AI智能聊天功能、rag文档查询，文档上传，后端接口采用Spring Boot+langchain4j+ollama+deepseek+qwen3开发

## 主要特性

- **跨平台支持**：基于c++语言，支持多端发布（如mac、windows、linux）。
- **现代化技术栈**：采用qt进行高效开发。
- **AI智能聊天**：为用户提供智能化的聊天体验。

### 后端对接
- **接口服务**：SpringBoot3 + MyBatis
- **AI 服务**：SpringAI + ollma + DeepSeek-r1/Qwen3.5 本地模型
...
![PC端主界面](PC端主界面.png)
![PC端聊天界面](PC端聊天界面.png)
![PC端聊天界面2](PC端聊天界面2.png)
![PC端聊天界面3](PC端聊天界面3.png)
![PC端聊天界面4](PC端聊天界面4.png)
另外有手机app版本，参照如下
